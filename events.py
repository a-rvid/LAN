...
class LanEventManager:
    ...
    def display_events(self, screen, font, position, size=(300, 500), border=10):

        # Draw a semi-transparent background for the event list
        pygame.draw.rect(
            screen,
            (128, 128, 128, 150),  # Semi-transparent gray
        ...
        for event in self.events:
            ...
            text_surface, _ = font.render(str(event), fgcolor=(255, 255, 255))
